# Boot the DMAengine validation image over JTAG without touching QSPI or SD.
...
set dtb_file [file join $images_dir zynq7020-fft-jtag.dtb]
...
con -addr 0x02000000
after 15000
puts "JTAG_DMAENGINE_BOOT: Linux started; run scripts/test_dmaengine_stress.ps1 over direct Ethernet."
